1.a script that changes your user ID to betty.
2. a script that prints the effective userid of the current user.
...
10.a script that sets the mode of the file hello the same as s mode.
olleh
